...
decltype(auto) visit_variant(Variant &&variant,
	...
	return std::visit(make_overload{
...
std::string token_type_to_string(TokenType type) noexcept {
	switch (type) {
		...
		case TokenType::Left_Square_Brace: return "[";
		case TokenType::Left_Curly_Brace: return "{";
		case TokenType::Right_Brace: return ")";
		case TokenType::Right_Square_Brace: return "]";
		case TokenType::Right_Curly_Brace: return "}";
		...
		case TokenType::Double_Dots: return ":";
		case TokenType::Arrow: return "->";
		case TokenType::Dict: return "dict";
		case TokenType::List: return "list";
		default:
			return "TokenType not stringified "
				+ std::to_string((uint8_t) type);
	}
}
