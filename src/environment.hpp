...
class Env {
public:
    [[maybe_unused]] virtual void assign(const std::string&, T, bool is_const = false) = 0;

    [[maybe_unused]] virtual T& get(const std::string&) = 0;

    [[maybe_unused]] virtual bool is_bound(const std::string&) = 0;

    [[maybe_unused]] virtual void bind(const std::string&, T, bool is_const = false) = 0;
    [[nodiscard]]
...
public:
    ...
    void bind(const std::string&, RuntimeValue, bool is_const = false) override;
